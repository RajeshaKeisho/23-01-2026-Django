...
def morning_message(request):
    ...
    return HttpResponse(" <h2 >Hello, Good Morning! Now the date and time is: " + formatted_time + "</h2>")

def noon_message(request):
    time = datetime.datetime.now()
    formatted_time = time.strftime("%d-%m-%Y %H:%M:%S")
    return HttpResponse(" <h2 >Hello, Good Noon! Now the date and time is: " + formatted_time + "</h2>")


def evening_message(request):
    time = datetime.datetime.now()
    formatted_time = time.strftime("%d-%m-%Y %H:%M:%S")
    return HttpResponse(" <h2 >Hello, Good Evening! Now the date and time is: " + formatted_time + "</h2>")
